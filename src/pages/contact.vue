    ...
    <div class="container">
      <div class="pages-wrapper">
        ...
        <a-row type="flex" :gutter="[{ xl: 24, sm: 16, xs: 16 }, { xl: 24, sm: 16, xs: 16 }]">
          ...
          <a-col :md="12" :sm="24" v-for="(branch, index) in branches" :key="index">
            <div class="contact-info">
              <h3>
                {{ branch.name }}
              </h3>
              ...
              <iframe :src="branch.map_link" style="border:0;" allowfullscreen="" loading="lazy"
